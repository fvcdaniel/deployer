...
ActiveRecord::Schema.define(:version => 20140923160525) do
  ...
  create_table "apps", :force => true do |t|
    ...
    t.datetime "created_at",    :null => false
    t.datetime "updated_at",    :null => false
    t.string   "ultima_acao"
    t.string   "user_acao"
  end

  add_index "apps", ["secretaria_id"], :name => "index_apps_on_secretaria_id"

  create_table "apps_appservers", :id => false, :force => true do |t|
    t.integer "app_id"
    t.integer "appserver_id"
  end
  ...
  create_table "appservers", :force => true do |t|
    t.string   "ip"
    t.integer  "port"
    t.string   "path"
    t.string   "dpath"
